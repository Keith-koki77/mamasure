        ...
        <div className="relative grid items-center gap-10 px-8 py-10 lg:grid-cols-[320px_1fr_340px] lg:px-14 lg:py-14">
          ...
          <div className="flex flex-col items-center lg:items-end">
            <Link
              ...
              className="group flex w-full max-w-xs items-center justify-center gap-3 rounded-2xl bg-white px-8 py-5 text-lg font-bold text-pink-600 shadow-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl lg:w-auto"
            >
              Join the Waitlist
            ...
            <div className="mt-6 flex items-center gap-3 text-sm text-purple-100">
              ...
              <span>No commitment. Just better preparation.</span>
            </div>
          </div>
        </div>
      </div>
